document.addEventListener('DOMContentLoaded', () => {
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('https://campus-backend-llfv.onrender.com/api/auth/register', {
                    method: 'POST',
                    headers: {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('https://campus-backend-llfv.onrender.com/api/auth/login', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
